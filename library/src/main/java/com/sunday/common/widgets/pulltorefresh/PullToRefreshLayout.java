package com.sunday.common.widgets.pulltorefresh;
...
import com.sunday.common.widgets.pulltorefresh.pullableview.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	public void refreshFinish(int refreshResult)
	{
		...
		case SUCCEED:
			// ˢ�³ɹ�
			LastTimeText.setVisibility(View.GONE);
	...
	private void changeState(int to)
	{
		...
		case INIT:
			// �������ֳ�ʼ״̬
			LastTimeText.setVisibility(View.VISIBLE);
	...
	public boolean dispatchTouchEvent(MotionEvent ev)
	{
		...
		case MotionEvent.ACTION_MOVE:
			...
			float Y=ev.getY();
//			
			if(Math.abs(X-startX)>20  &&Math.abs(Y-downY)<50){
	...
	public void UpdateTime(){
		LastTimeText.setText(getResources().getString(R.string.pull_to_refresh_lasttime) + 
	...
	private void initView()
	{
		...
		//���һ�θ���ʱ��
		LastTimeText=(TextView) findViewById(R.id.time_tv);
