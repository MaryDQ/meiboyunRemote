package com.sunday.common.widgets.wheelpicker.view;
...
public abstract class WheelCrossPicker extends AbstractWheelPicker
    ...
    protected void drawBackground(Canvas canvas) {
        if(hasBackground){
            ...
            rectCurItem.set(rectCurItem.left,rectCurItem.top,rectCurItem.right,rectCurItem.bottom);
    ...
    private void confirmData() {
        if (state != SCROLL_STATE_IDLE || data.isEmpty()) {
            return;
        }
     ...
     * 设置当前Item项的背景颜色
     *
     * @param hasBackground 是否有 背景颜色
     * @param color        背景颜色值
     */
    public void setCurrentBackground(boolean hasBackground, String  color){
